...
CREATE TABLE `estimateinfo` (
  `id` int(9) NOT NULL AUTO_INCREMENT COMMENT '评价id(自增)',
  `content` text NOT NULL COMMENT '评价详情',
...
CREATE TABLE `goodsinfo` (
  `id` int(9) NOT NULL AUTO_INCREMENT COMMENT '用品id',
  `name` varchar(50) NOT NULL COMMENT '用品名',
  `kind` int(2) NOT NULL COMMENT '用品类别(1=''排球'';2=''护具'';3=''鞋服'';4=''其他'')',
  `price` int(5) NOT NULL COMMENT '官方价格',
  `estimate_num` int(9) NOT NULL DEFAULT '0' COMMENT '评论数',
  `people` int(50) NOT NULL DEFAULT '0' COMMENT '人气值',
  `img` varchar(255) DEFAULT NULL COMMENT '用品图像',
  `publisher_id` varchar(20) NOT NULL COMMENT '发布人id',
  `publish_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '发布时间',
  PRIMARY KEY (`id`)
...
-- ----------------------------
DROP TABLE IF EXISTS `newgoodsinfo`;
CREATE TABLE `newgoodsinfo` (
  `id` int(9) NOT NULL AUTO_INCREMENT COMMENT '待审核的新用品id',
  `name` varchar(50) NOT NULL,
  `kind` int(2) NOT NULL COMMENT '用品类别(1=''排球'';2=''护具'';3=''鞋服'';4=''其他'')',
  `price` int(5) NOT NULL COMMENT '新用品详情',
  `img` varchar(255) DEFAULT NULL COMMENT '新用品图像',
  `uploader_id` varchar(20) NOT NULL COMMENT '上传者id',
  `upload_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上传时间',
  `isAudited` int(2) NOT NULL DEFAULT '0' COMMENT '是否已审核(0="未审核", 1="审核通过", 2="审核不通过")',
...
-- ----------------------------
DROP TABLE IF EXISTS `newvbplaceinfo`;
CREATE TABLE `newvbplaceinfo` (
  `id` int(9) NOT NULL AUTO_INCREMENT COMMENT '待审核的新球场(自增)',
  `location` varchar(50) NOT NULL COMMENT '球场位置',
...
CREATE TABLE `postinfo` (
  `id` int(9) NOT NULL AUTO_INCREMENT COMMENT '帖子id',
  `title` varchar(20) DEFAULT NULL COMMENT '帖子标题',
  `content` text NOT NULL COMMENT '帖子详情',
  `followId` int(9) DEFAULT NULL COMMENT '跟帖id',
  `publisher_id` varchar(20) NOT NULL COMMENT '发布人id',
  `publish_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '发布时间',
...
-- ----------------------------
DROP TABLE IF EXISTS `vbplaceinfo`;
CREATE TABLE `vbplaceinfo` (
  `id` int(9) NOT NULL AUTO_INCREMENT COMMENT '球场id',
  `location` varchar(50) NOT NULL COMMENT '球场位置',
  `province` varchar(20) NOT NULL COMMENT '省',
  `city` varchar(20) NOT NULL COMMENT '市',
  `area` varchar(20) NOT NULL COMMENT '区',
  `post_num` int(9) NOT NULL DEFAULT '0' COMMENT '帖子数',
  `people` int(50) NOT NULL DEFAULT '0' COMMENT '人气值',
  `img` varchar(255) DEFAULT NULL COMMENT '球场图片',
  `publisher_id` varchar(20) NOT NULL COMMENT '发布人id',
  `publish_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '发布时间',
